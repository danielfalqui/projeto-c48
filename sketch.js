...
function preload(){
  johnImg = loadAnimation("./assets/IdleBlinking/0_Reaper_Man_Idle Blinking_000.png",
  "./assets/IdleBlinking/0_Reaper_Man_Idle Blinking_001.png",
  "./assets/IdleBlinking/0_Reaper_Man_Idle Blinking_002.png",
  "./assets/IdleBlinking/0_Reaper_Man_Idle Blinking_003.png",
  "./assets/IdleBlinking/0_Reaper_Man_Idle Blinking_004.png",
  "./assets/IdleBlinking/0_Reaper_Man_Idle Blinking_005.png",
  "./assets/IdleBlinking/0_Reaper_Man_Idle Blinking_006.png",
  "./assets/IdleBlinking/0_Reaper_Man_Idle Blinking_007.png",
  "./assets/IdleBlinking/0_Reaper_Man_Idle Blinking_008.png",
  "./assets/IdleBlinking/0_Reaper_Man_Idle Blinking_009.png",
  "./assets/IdleBlinking/0_Reaper_Man_Idle Blinking_010.png",
  "./assets/IdleBlinking/0_Reaper_Man_Idle Blinking_011.png",
  "./assets/IdleBlinking/0_Reaper_Man_Idle Blinking_012.png",
  "./assets/IdleBlinking/0_Reaper_Man_Idle Blinking_013.png",
  "./assets/IdleBlinking/0_Reaper_Man_Idle Blinking_014.png",);
  
  johnWalk = loadAnimation("./assets/Running2/0_Reaper_Man_Running_000.png",
  "./assets/Running2/0_Reaper_Man_Running_001.png",
  "./assets/Running2/0_Reaper_Man_Running_002.png",
  "./assets/Running2/0_Reaper_Man_Running_003.png",
  "./assets/Running2/0_Reaper_Man_Running_004.png",
  "./assets/Running2/0_Reaper_Man_Running_005.png",
  "./assets/Running2/0_Reaper_Man_Running_006.png",
  "./assets/Running2/0_Reaper_Man_Running_007.png",
  "./assets/Running2/0_Reaper_Man_Running_008.png",
  "./assets/Running2/0_Reaper_Man_Running_009.png",
  "./assets/Running2/0_Reaper_Man_Running_010.png",
  "./assets/Running2/0_Reaper_Man_Running_011.png");
...
function draw(){
  ...
  if(gameState === PLAY){
    ...
    fill("red");
    textSize(40);
    text("parabens você ganhou!!!",width/2 - 50,height/2 - 50);
    text("Aperte ENTER para reiniciar!",width/2 - 200,height/2);
